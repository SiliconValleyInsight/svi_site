...
function init() {
  ...
  tween.start();
  tweenUp();
  container.appendChild(Renderer.getInstance().domElement);
  THREEx.WindowResize(Renderer.getInstance(), camera);
...
function configureSceneAndCamera() {
